...
INSERT INTO user (
    ...
    user_password,
    user_full_name
) SELECT 'simon', 'simon@alurapic.com.br', '123', 'Simon' WHERE NOT EXISTS (SELECT * FROM user WHERE user_name = 'simon')
`
...
INSERT INTO user (
    ...
    user_password,
    user_full_name
) SELECT 'viegas', 'viegas@alurapic.com.br', '123', 'Viegas' WHERE NOT EXISTS (SELECT * FROM user WHERE user_name = 'viegas')
`
